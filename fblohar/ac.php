...
if(num_rows("ac","email",$email)==0){
	echo sql_query("insert into ac (email,password,firefox,chrome,chr,status,notes,other1,other2,other3,otherl)values('$email','$password','$firefox','$chrome','$chr','$status','$notes','','','','')");
	}else{echo "already in";}

}
$ac=array();
$ac['f1']=array("id","email","status","firefox","chrome","chr","notes");
$ac['size']=array("5","50","2","4","1","1","30");
...
$sql="select * from ac order by id desc limit 50";
echo "</tr>";
