...
<span id=page_header>Facebook Page Likes</span><br><br>

<p id=para>
Like Facebook Page and get money. You can get upto Rs.0.20/- for every Facebook Page You like. First Click On Like Button the new window will open with faecbook page. Like that facebook page and clsoe the window. Wait for 2-3 second and you will get money for liking it.
</p>
<div id=next_page>
<center>
...
xmlhttp.open("GET","pages/next_page.php?type=earn-facebook",true);
xmlhttp.send();
...
xmlhttp.open("GET","pages/process_like.php?action=earn-facebook&id="+window.next_obj[0]+"&result="+result+"&points="+points+"&userid="+userid,true);
xmlhttp.send();	
}
